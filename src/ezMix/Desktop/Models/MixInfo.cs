namespace Desktop.Models
{
    public class MixInfo
    {
        ...
        public string[] Versions { get; set; } = [];        // Danh sách mã đề
        ...
        public string TestPeriod { get; set; } = "KIỂM TRA GIỮA KÌ 1";      // Tên bài kiểm tra
        ...
        public bool IsFixMathType { get; set; } = true;             // Sửa công thức MathType
        public bool IsDeleteLogWhenStart { get; set; } = true;      // Xóa nhật ký khi bắt đầu
