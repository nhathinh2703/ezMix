...
namespace MTGetEquationAddin
{
    ...
    public class Connect : Object, Extensibility.IDTExtensibility2
    {
        ...
        public int IterateShapes(ref Word.InlineShapes shapes, bool isSetData, bool isMathML)
        {
        ...
        public bool DoesServerExist(ref Guid guidToCheck)
        {
            //        bool doesServerExists = false;
            ...
            string regLocation = $@"Software\Classes\CLSID\{{{guidToCheck}}}\LocalServer32";
                ...
                .OpenSubKey(regLocation))
            {
                ...
                string pathToExe = regKey.GetValue(valueNames[0]) as string;
                return !string.IsNullOrEmpty(pathToExe) && File.Exists(pathToExe);
            }
        ...
        public int GetVerbIndex(string verbToFind, ref Guid guidToCheck)
        {
        ...
        public void RecurseAutoConvert(ref Guid guidToCheck, out Guid autoConvert)
        {
            int comRetVal = 0;
        ...
        public bool FindAutoConvert(ref string progID, out Guid autoConvert)
        {
            bool retVal = false;
            Guid outputGuid;
            int comRetVal = 0;
        ...
        /// <returns></returns>
        public bool DoesServerSupportFormat(ref Guid guidToCheck, ref string dataFormat)
        {
        ...
        public void Equation_GetData(ref Word.InlineShape shape, ref string dataFormatRequested, int indexForVerb, bool isMathML)
        {
            if (shape != null)
            {
        ...
        public void Equation_SetData(ref Word.InlineShape shape, ref string dataFormatRequested, int indexForVerb, bool isMathML)
        {
            if (shape != null)
            {
                IDataObject oleDataObject;
        ...
        public void WriteOutEquationFromStgMedium(ref ConnectSTGMEDIUM stgMedium)
        {
            IntPtr ptr;
            byte[] rawArray = null;
        ...
        public void GetSimpleEqn(bool isMathML, out string simpleEqn)
        {
            simpleEqn = "";
